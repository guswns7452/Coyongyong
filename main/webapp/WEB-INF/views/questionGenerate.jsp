...
<%@ taglib prefix="c"  uri="http://java.sun.com/jsp/jstl/core"%>
	...
	<head>
		...
		<title>coyongyong_questionGenerate</title>
		<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/views/CP_CoP_front/questionGenerate.css">
	...
	<body>
          ...
          <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="flex items-center md:order-2">
              ...
              <div
                ...
                id="user-dropdown">
                <div class="px-4 py-3">
                  <span class="block text-sm text-gray-900 dark:text-white">${customer.name} : ${customer.customerNickname}</span>
							...
							<form name=form action="http://localhost:8080/question/writequestion" method="post">
								<div class="block gap-4 sm:grid-cols-2 sm:gap-6">
									<div class="sm:col-span-2 w-full">
										<label for="name"
											class="block mb-2 text-sm font-medium text-gray-900 dark:text-white w-full">질문
											제목 작성</label>
										<input type="text" name="questionTitle" id="name"
									...
									<div class="flex flex-end">
										<select id="category"
											class="bg-gray-50 border border-primary-300 text-primary-900 text-sm rounded-lg border-primary-700 focus:ring-0 dark:bg-primary-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 margin-bottom language-selecter input">
									...
									<div>
										<div class="sm:col-span-2">
											<div
												class="w-full text-sm text-gray-900 bg-gray-100 rounded-lg focus:ring-0 border-primary-700 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
												<!-- Modal toggle -->
												<div class="flex m-5">
														...
														<div
															...
															<form action="#">
																...
																<button id="defaultModalButton"
																	data-modal-toggle="defaultModal"
																	class="block text-white bg-lime-700
							  focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 code_btn"
												...
												<label for="description"
													class="flex mb-2 text-sm font-medium text-gray-900 dark:text-white">질문
													내용
													작성</label>
												<textarea name="questionContent" id="description"
													class="flex p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-primary-300 focus:ring-0 border-primary-700 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 questionContent input"
													placeholder="질문 내용을 작성하세요." required="" rows="15"></textarea>
												<label for="description"
													class="flex mb-2 text-sm font-medium text-gray-900 dark:text-white">오류
													내용
													작성</label>
												<textarea id="description"
													class="flex p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-primary-300 focus:ring-0 border-primary-700 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 studyJournalContent input"
													placeholder="오류 내용을 작성하세요." required="" rows="5"></textarea>
		...
		<footer class="p-4 bg-white md:p-8 lg:p-10 dark:bg-gray-800">
			<div class="mx-auto max-w-screen-xl text-center">
				...
				<p class="my-6 text-gray-500 dark:text-gray-400">TUKOREA CP-CoP Dragon and Horse Coding knowledge
					sharing site with ChatGPT API</p>
		...
		<script src="${pageContext.request.contextPath}/resources/views/CP_CoP_front/questionGenerate.js"></script>
			...
			function initMonaco() {
				...
				require(['vs/editor/editor.main'], function () {
					...
					editor = monaco.editor.create(document.getElementById('monaco-container'), {
						value: 'dfsljfdlksjflksdlfkjslkfjsldfkjsldk',
						language: 'c',
						automaticLayout: true,
						theme: 'vs-dark'
					});
