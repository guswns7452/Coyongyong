...
<head>
  ...
  <title>Coyongyong_questionMain_C#</title>
  <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/views/CP_CoP_front/CP_CoP_questionMain_Csharp.css">
</head>
...
<body>
  <main>
    ...
    <div class="level1">
      <div class="questions">
        <head class="level"><img src="${pageContext.request.contextPath}/resources/views/CP_CoP_front/icon/Csharp_1.png" width="120px" height="120px"></head>
    ...
    <div class="other_level">
      <div class="questions">
        <head class="level"><img src="${pageContext.request.contextPath}/resources/views/CP_CoP_front/icon/Csharp_2.png" width="120px" height="120px"></head>
        <div class="one_question">
          <a class="question" href="#">
          질문2<br>&nbsp;질문내용<br>길면 어쩔껀데?<br>이렇게까지 길면 어떻게 될꼰뒝? 가로가 길면 어떻게 될꺼야?<br>더 길면 어떻게 되지 넘어가니? 어쩔꺼냐구~ 더 길어야하니...? 어디까지 가야하니..? 와 아직도 안됐어 질문이 보통 이렇게 길겠지?
          </a>
      ...
      <!-- 세번째 레벨 ------------------------------------->
      <div class="questions">
        <head class="level"><img src="${pageContext.request.contextPath}/resources/views/CP_CoP_front/icon/Csharp_3.png" width="120px" height="120px"></head>
        <div class="one_question">
          <a class="question" href="#">
          질문2<br>&nbsp;질문내용<br>길면 어쩔껀데?<br>이렇게까지 길면 어떻게 될꼰뒝? 가로가 길면 어떻게 될꺼야?<br>더 길면 어떻게 되지 넘어가니? 어쩔꺼냐구~ 더 길어야하니...? 어디까지 가야하니..? 와 아직도 안됐어 질문이 보통 이렇게 길겠지?
          </a>
      ...
      <!-- 네번째 레벨 ----------------------------------------->
      <div class="questions">
        <head class="level"><img src="${pageContext.request.contextPath}/resources/views/CP_CoP_front/icon/Csharp_4.png" width="120px" height="120px"></head>
        <div class="one_question">
          <a class="question" href="#">
          질문2<br>&nbsp;질문내용<br>길면 어쩔껀데?<br>이렇게까지 길면 어떻게 될꼰뒝? 가로가 길면 어떻게 될꺼야?<br>더 길면 어떻게 되지 넘어가니? 어쩔꺼냐구~ 더 길어야하니...? 어디까지 가야하니..? 와 아직도 안됐어 질문이 보통 이렇게 길겠지?
          </a>
