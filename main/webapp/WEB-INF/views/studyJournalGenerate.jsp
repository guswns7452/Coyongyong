...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/views/CP_CoP_front/studyJournalGenerate.css">
...
<body>
	...
	<main>
		<div class="top out-bg-green-10">
			<div class="toptop rounded-lg p-2.5">
				<div class="title">
					<font size=6> 공부일지 작성 </font>
				</div>
				<section class="dark:bg-gray-900 background">
					<div id="top">
						<form id="studyWrite" action="/study/writestudy" method="post">
							<div class="block gap-4 sm:grid-cols-2 sm:gap-6">
								...
								<div class="sm:col-span-2 w-full">
									...
									<div class="div w-full">
										<input type="text" name="studyTitle" required=""
											class="input w-full focus:ring-0"> <label
											class="label">공부일지 제목 작성</label> <span class="span"></span>
									</div>
								</div>
								<label for="category"
								...
								<div>
									<div class="sm:col-span-2">
										...
										<div
											class="w-full text-sm text-gray-900 rounded-lg focus:ring-0 border-primary-700 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
											<!-- Modal toggle -->
											<div class="flex m-5">
                                      ...
                                      <path fill-rule="evenodd"
														...
														<form action="#">
															...
															<button id="defaultModalButton"
																...
																class="block text-white bg-lime-700
                              focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 code-btn"			
																type="button" onclick="javascript: submitCode(); addCodeForm();">
																코드 제출</button>
														</form>
													</div>
												</div>
											...
											<form class="border-lime-500 margin-bottom">
												<div
													...
													<div
														...
														<div
															class="flex flex-wrap items-centersm:divide-x dark:divide-gray-600">
															<div class="flex items-center space-x-1 sm:pr-4">
																<button type="button"
																	class="p-2 text-gray-500 rounded cursor-pointer hover:text-gray-900 bg-green-300 bg-green-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600"
																	onclick="btnBold()">
																	<img
																		src="${pageContext.request.contextPath}/resources/views/CP_CoP_front/icon/bold.png"
																		class="w-4 h-4">
																</button>
																<button type="button"
																	class="p-2 text-gray-500 rounded cursor-pointer hover:text-gray-900 bg-green-300 bg-green-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600"
																	onclick="btnItalic()">
																	<img
																		src="${pageContext.request.contextPath}/resources/views/CP_CoP_front/icon/italic.png"
																		class="w-4 h-4">
																</button>
																<button type="button"
																	class="p-2 text-gray-500 rounded cursor-pointer hover:text-gray-900 bg-green-300 bg-green-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600"
																	onclick="btnUnderline()">
																	<img
																		src="${pageContext.request.contextPath}/resources/views/CP_CoP_front/icon/underline.png"
																		class="w-4 h-4">
																</button>
																<button type="button"
																	class="p-2 text-gray-500 rounded cursor-pointer hover:text-gray-900 bg-green-300 bg-green-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600"
																	onclick="btnStrike()">
																	<img
																		src="${pageContext.request.contextPath}/resources/views/CP_CoP_front/icon/strike.png"
																		class="w-4 h-4">
																</button>
															</div>
															<div
																...
																<button type="button"
																	...
																	onclick="alignLeft()">
																	<img
																		src="${pageContext.request.contextPath}/resources/views/CP_CoP_front/icon/align-left.png"
																		class="w-4 h-4">
																</button>
																<button type="button"
																	class="p-2 text-gray-500 rounded cursor-pointer hover:text-gray-900 bg-green-300 bg-green-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600"
																	onclick="alignCenter()">
																	<img
																		src="${pageContext.request.contextPath}/resources/views/CP_CoP_front/icon/align-center.png"
																		class="w-4 h-4">
																</button>
																<button type="button"
																	class="p-2 text-gray-500 rounded cursor-pointer hover:text-gray-900 bg-green-300 bg-green-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600"
																	onclick="alignRight()">
																	<img
																		src="${pageContext.request.contextPath}/resources/views/CP_CoP_front/icon/align-right.png"
																		class="w-4 h-4">
																</button>
																<button type="button"
																	class="mr-3 text-sm rounded-full md:mr-0 focus:ring-gray-300 bg-green-300 bg-green-100 dark:focus:ring-gray-600"
																	id="user-menu-button" aria-expanded="false"
																	data-dropdown-toggle="size-dropdown"
																	data-dropdown-placement="bottom">
																	<img width="22px" height="22px"
																		src="${pageContext.request.contextPath}/resources/views/CP_CoP_front/icon/font.png"
																		alt="user photo">
																</button>
																<div
																	class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600"
																	...
																	<ul class="py-2" aria-labelledby="user-menu-button">
																		<li>
																			<button type="button" class="styleBtn"
																				onclick="changeTextSize(14)">
																				<img
																					src="${pageContext.request.contextPath}/resources/views/CP_CoP_front/icon/size.png"
																					width="15px" height="15px">
																			</button>
																		</li>
																		<li>
																			<button type="button" class="styleBtn"
																				onclick="changeTextSize(20)">
																				<img
																					src="${pageContext.request.contextPath}/resources/views/CP_CoP_front/icon/size.png"
												...
												<div
													...
													<label for="description"
														class="flex mb-2 text-sm font-medium text-gray-900 dark:text-white">공부일지내용
														작성</label> <label for="editor" class="sr-only">제출하기</label>
													<div id="myTextarea"
	...
	<script
		src="${pageContext.request.contextPath}/resources/views/CP_CoP_front/studyJournalGenerate.js"></script>
	<script
	...
	<script>
		function submitForm() {
			...
			hiddenInput.name = 'studyContent';
			hiddenInput.value = divContent; 
			document.getElementById('studyWrite').appendChild(hiddenInput);
			if(divContent.trim() != ''){
				document.getElementById('studyWrite').submit();
			}
			else{
				alert("공부 일지 내용을 작성하세요!");
			}	
		}
	</script>
...
<script>
		...
		function addCodeForm() {
			if (editor.getValue()) {
				...
				hiddenInputCode.name = 'studyCode';
				hiddenInputCode.value = editor.getValue();
				document.getElementById('studyWrite').appendChild(
						hiddenInputCode);
			}
		}
	</script>
