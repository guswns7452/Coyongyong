            ...
            <div class="toptop rounded-lg p-2.5">
               ...
               <div class="background">
                  <figure class="max-w-screen-md title">
                     <figcaption class="flex items-center space-x-3">
                        ...
                        <div class="items-center divide-x-2 divide-gray-300 dark:divide-gray-700">
                           <cite class="pr-3 font-medium text-gray-900 dark:text-white">${question.customerID} </cite>
                        </div>
                     </figcaption>
                  </figure>
                  <div class="question_title">
                     <div class="flex justify-between">
                        <span id="question_title">
                           <font size=4>${question.questionTitle}
                           </font>
                        </span>
                     </div>
                  </div>
                  <div class="question_content">
                     ...
                     <h4> <br> ${question.questionContent} </br> <br> ${question.questionCode} </br>  ${question.questionError} </h4>
               ...
               <section class="dark:bg-gray-900 background">
                  <div id="top">
                     <form id="writeAnswerCus" action="/question/writequestionanswer" method="post">
                           ...
                           <div class="sm:col-span-2 w-full">
                              ...
                              <div class="div w-full">
                                 <input type="text" name="answerCusTitle" required=""
                                    class="input w-full focus:ring-0"> <label class="label">답변 제목 작성</label>
                                       ...
                                       <form class="border-lime-500">
                                             ...
                                             <div
                                                ...
                                                <div class="flex m-5">
                                                   <button id="defaultModalButton"
                                                      data-modal-toggle="defaultModal"
                                                      class="block text-white bg-lime-700 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 code-btn"
                                                      type="button" onclick="checkLanguage()">코드 작성하기
                                                   </button>
                                                </div>
                                             </div>
                                          </div>
                                          <div class="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
                                             <label for="description"
                                                ...
                                                내용 작성</label> <label for="editor"
                                                class="sr-only">제출하기</label>
                                             <div id="myTextarea"
      ...
      <footer class="p-4 bg-white md:p-8 lg:p-10 dark:bg-gray-800">
         <div class="mx-auto max-w-screen-xl text-center">
            ...
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">©
               2023 <a href="https://www.tukorea.ac.kr/tukorea/index.do#none" class="hover:underline">TUKOREA</a>.
               All Rights Reserved.
            </span>
         </div>
      </footer>
