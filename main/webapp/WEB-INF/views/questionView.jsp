			...
			<div class="toptop">
				...
				<div class="white-block">
					...
					<div class="question_content">
						...
						<div class="flex">
							<h3 id="question_language">
								<c:choose>
									...
									<c:when test="${gradeCustomer.languageNum eq 3}">Java</c:when>
								</c:choose>
						...
						<div>오류 내용 <br><br> ${question.questionError }</div>
			...
			<div class="flex-grow">
				<div class="flex questionList">
					<c:forEach items="${questions}" var="question" begin="1" end="4">
						<c:set var="i"><%=java.lang.Math.round(java.lang.Math.random() * 16)%></c:set>
						<a class="question"
