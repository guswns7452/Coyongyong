...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/views/CP_CoP_front/right_problem.css">
<link
...
<body>
	...
	<div id="container">
		<img class="congra"
			src="${pageContext.request.contextPath}/resources/views/CP_CoP_front/icon/frustrated.png">
