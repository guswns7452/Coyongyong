            ...
            <div class="mypage__flex">
                <div
                    ...
                    <div class="flex flex-col items-center pb-10">
                        ...
                        <span class="text-sm text-gray-500 dark:text-gray-400">전현준</span>
                        <div class="flex mt-4 space-x-3 md:mt-6">
                            <button data-modal-target="authentication-modal" data-modal-toggle="authentication-modal"
                                type="button"
                                class="focus:outline-none text-white button_color  focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 ">비밀번호
                                변경</button>
                        </div>
                        <div class="flex mt-4 space-x-3 md:mt-6">
                            <button type="button"
                                class="focus:outline-none text-white button_color focus:ring-4  font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 ">회원정보
                                확인</button>
                        </div>
                    </div>
                </div>
                ...
                <% mypageController a = new mypageController(); %>
                    <div
                        ...
                        <ul class="flex flex-wrap -mb-px">
                            <li class="mr-2">
                                <a href="<% a.mypage(); %>"
                                    class="inline-block p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300">대시보드</a>
                            </li>
                            <li class="mr-2">
                                <a href="<% a.mypageQuestion(); %>"
                                    class="inline-block p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300"
                                    aria-current="page">질문</a>
                            </li>
                            <li class="mr-2">
                                <a href="http://localhost:8080/mypage/study"
