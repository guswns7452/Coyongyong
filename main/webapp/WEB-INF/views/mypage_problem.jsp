...
<!--=============== CSS ===============-->
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/views/CP_CoP_front/mypage.css">
<link
...
<body>
		...
		<div class="flex_mode">
			<div class="mypage__flex">
					...
					<div class="relative w-full max-w-md max-h-full">
						...
						<div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
							...
							<div class="px-6 py-6 lg:px-8">
								<h3
									class="mb-4 text-xl font-medium text-gray-900 dark:text-white">비밀번호
									변경</h3>
								<form class="space-y-6" action="#">
									<div>
										<label for="password"
											class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
											현재 비밀번호</label> <input type="password" name="password" id="password"
											placeholder="••••••••"
									...
									<div>
										<label for="password"
											...
											비밀번호</label> <input type="password" name="password" id="password"
											placeholder="••••••••"
											class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
											required>
									</div>
				...
				<div class="toptoptop">
					<div
						...
						<ul class="flex flex-wrap -mb-px">
							...
							<li class="mr-2"><a href="/mypage/problem"
								class="inline-block p-4 text-blue-600 border-b-2 border-blue-600 rounded-t-lg active dark:text-blue-500 dark:border-blue-500 font-semibold">레벨</a>
							</li>
							<!-- <li>
                                <a
					...
					<div
						class="ProfileActivity_streak__AwMtA ProfileActivity_item__DqwKL">
						...
						<div class="grid grid-cols-3 md:grid-cols-3 gap-6">
							<div>
								<div
									...
									<div
										style="background-image: url('${pageContext.request.contextPath}/resources/views/CP_CoP_front/icon/seed.png');"
										class="profile-user-img"></div>
									<a href="#">
										<h5
									...
									<p
										class="mb-3 font-normal text-gray-700 dark:text-gray-400 font-semibold">level
										1</p>
									<div class="DetailBadge_userCount__ZoF9Q">
										문제를 풀어보고 <br> 레벨을 열어보세요!
									</div>
								</div>
							</div>
							<div>
								<div
									...
									<div
										style="background-image: url('${pageContext.request.contextPath}/resources/views/CP_CoP_front/icon/seed.png');"
										class="bg-white profile-user-img"></div>
									<a href="#">
										<h5
											class="mt-3 mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
											Java</h5>
							...
							<div>
								<div
									class="bg-gray-50 p-6 flex flex-col align-center max-w-sm border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
									<div
										style="background-image: url('${pageContext.request.contextPath}/resources/views/CP_CoP_front/icon/locked.png');"
										class="bg-white profile-user-img"></div>
									<a href="#">
										<h5
											class="mt-3 mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
									...
									<p
										class="mb-3 font-normal text-gray-700 dark:text-gray-400 font-semibold">level
										0</p>
									<div class="DetailBadge_userCount__ZoF9Q">준비중</div>
								</div>
							</div>
							<div>
								<div
				...
				<div id="toast-interactive"
					...
					<div class="flex">
						...
						<div class="ml-3 text-sm font-normal">
							<span
								class="mb-1 text-sm font-semibold text-gray-900 dark:text-white">비밀번호
								변경</span>
							<div class="mb-2 text-sm font-normal">고객님의 비밀번호 변경이
								완료되었습니다.</div>
	...
	<script
		src="${pageContext.request.contextPath}/resources/views/CP_CoP_front/icon/mypage.js"></script>
</body>
