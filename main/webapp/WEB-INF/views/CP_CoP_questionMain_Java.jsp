...
<body>
  <main>
    ...
    <div class="topbar">
      <div class="logo"><br>
        <a href="http://127.0.0.1:5500/CP_CoP_Main.html"><img src="${pageContext.request.contextPath}/resources/views/CP_CoP_front/icon/logo.png"></a>
      </div>
    ...
    <div class="menubar">
      <div>
        <a href="http://127.0.0.1:5500/CP_CoP_questionMain.html" id="main_question_btn" class="menubtn">질문</a>
    ...
    <div class="level1">
      <div class="questions">
        <head class="level"><img src="${pageContext.request.contextPath}/resources/views/CP_CoP_front/icon/Java_1.png" width="120px" height="120px"></head>
    ...
    <!-- 두번째 레벨 --------------------------------------->
    <div class="questions">
      <head class="level"><img src="${pageContext.request.contextPath}/resources/views/CP_CoP_front/icon/Java_2.png" width="120px" height="120px"></head>
      <div class="one_question">
        <a class="question" href="#">
        질문2<br>&nbsp;질문내용<br>길면 어쩔껀데?<br>이렇게까지 길면 어떻게 될꼰뒝? 가로가 길면 어떻게 될꺼야?<br>더 길면 어떻게 되지 넘어가니? 어쩔꺼냐구~ 더 길어야하니...? 어디까지 가야하니..? 와 아직도 안됐어 질문이 보통 이렇게 길겠지?
        </a>
    ...
    <!-- 세번째 레벨 ------------------------------------->
    <div class="questions">
      <head class="level"><img src="${pageContext.request.contextPath}/resources/views/CP_CoP_front/icon/Java_3.png" width="120px" height="120px"></head>
      <div class="one_question">
        <a class="question" href="#">
        질문2<br>&nbsp;질문내용<br>길면 어쩔껀데?<br>이렇게까지 길면 어떻게 될꼰뒝? 가로가 길면 어떻게 될꺼야?<br>더 길면 어떻게 되지 넘어가니? 어쩔꺼냐구~ 더 길어야하니...? 어디까지 가야하니..? 와 아직도 안됐어 질문이 보통 이렇게 길겠지?
        </a>
    ...
    <!-- 네번째 레벨 ----------------------------------------->
    <div class="questions">
      <head class="level"><img src="${pageContext.request.contextPath}/resources/views/CP_CoP_front/icon/Java_4.png" width="120px" height="120px"></head>
      <div class="one_question">
        <a class="question" href="#">
        질문2<br>&nbsp;질문내용<br>길면 어쩔껀데?<br>이렇게까지 길면 어떻게 될꼰뒝? 가로가 길면 어떻게 될꺼야?<br>더 길면 어떻게 되지 넘어가니? 어쩔꺼냐구~ 더 길어야하니...? 어디까지 가야하니..? 와 아직도 안됐어 질문이 보통 이렇게 길겠지?
        </a>
