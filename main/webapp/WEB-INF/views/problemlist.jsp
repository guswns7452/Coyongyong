...
<%@ taglib prefix="c"  uri="http://java.sun.com/jsp/jstl/core"%>
  ...
  <body>
    ...
    <div class="out-bg-green-10 flexflextop">
        ...
        <div class="grid grid-cols-3 md:grid-cols-3 gap-6">
          <div>
            <div
              ...
              <p class="targetget mb-3 font-normal text-gray-700 dark:text-gray-400">Hello World!<br>컴퓨터와 인사하기</p>
          ...
          <div>
            <div
              ...
              <p class="targetget mb-3 font-normal text-gray-700 dark:text-gray-400">컴퓨터는 사실<br>계산기입니다.</p>
              <div class="text-right">
                <a href="/problem/play?num=${problems.get(0).problemNum}&language=${language}"
                  class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                  GO
