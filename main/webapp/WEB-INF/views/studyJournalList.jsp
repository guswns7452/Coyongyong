...
<%@ taglib prefix="c"  uri="http://java.sun.com/jsp/jstl/core"%>
    ...
    <head>
      ...
      <title>coyongyong_studyJournalList</title>
      <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/views/CP_CoP_front/studyJournalList.css">
    </head>
    ...
    <body>
      ...
      <script src="${pageContext.request.contextPath}/resources/views/CP_CoP_front/studyJournalList.js"></script>
